...
config_filename_map["mobilenet_v2_ssd-coco-true"]="pipeline_mobilenet_v2_ssd_coco_retrain_whole_model.config"
config_filename_map["mobilenet_v2_ssd-coco-false"]="pipeline_mobilenet_v2_ssd_coco_retrain_last_few_layers.config"
...
DATASET_DIR="${LEARN_DIR}/coco/subset"
